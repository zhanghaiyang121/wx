...
const api = {
    ...
    ai: {
      voice:base+'media/voice/addvoicetorecofortext?',
...
module.exports = class Wechat {
  ...
  pushvoice(token,format,voice_id,lang='zh_CN'){
    let url=`${api.ai.voice}access_token=${token}&format=${format}&voice_id=${voice_id}&lang=${lang}` 
    return { method: 'POST', url }
  }
